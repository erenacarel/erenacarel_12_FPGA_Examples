...
-- Date        : Wed May 15 15:09:12 2024
-- Host        : ERENACAREL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/eren1/VivadoProjects/project_03_burak_uart_rx_01/project_03_burak_uart_rx_01.sim/sim_1/impl/func/xsim/tb_uart_rx_func_impl.vhd
-- Design      : uart_rx
...
entity uart_rx is
  ...
  attribute \DesignAttr:ENABLE_AIE_NETLIST_VIEW\ of uart_rx : entity is std.standard.true;
  attribute \DesignAttr:ENABLE_NOC_NETLIST_VIEW\ : boolean;
  attribute \DesignAttr:ENABLE_NOC_NETLIST_VIEW\ of uart_rx : entity is std.standard.true;
  attribute ECO_CHECKSUM : string;
  attribute ECO_CHECKSUM of uart_rx : entity is "3df79d75";
...
architecture STRUCTURE of uart_rx is
  ...
  signal \shreg_reg[1]_lopt_replica_1\ : STD_LOGIC;
  signal \shreg_reg[2]_lopt_replica_1\ : STD_LOGIC;
  signal \shreg_reg[3]_lopt_replica_1\ : STD_LOGIC;
  signal \shreg_reg[4]_lopt_replica_1\ : STD_LOGIC;
  signal \shreg_reg[5]_lopt_replica_1\ : STD_LOGIC;
  signal \shreg_reg[6]_lopt_replica_1\ : STD_LOGIC;
  ...
  attribute OPT_MODIFIED of \dout_o_OBUF[1]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \dout_o_OBUF[2]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \dout_o_OBUF[3]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \dout_o_OBUF[4]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \dout_o_OBUF[5]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \dout_o_OBUF[6]_inst\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER : boolean;
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[1]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[1]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[2]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[2]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[3]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[3]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[4]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[4]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[5]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[5]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \shreg_reg[6]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \shreg_reg[6]_lopt_replica\ : label is "SWEEP";
begin
...
\shreg_reg[1]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shreg_reg[2]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shreg_reg[3]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shreg_reg[4]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shreg_reg[5]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shreg_reg[6]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
